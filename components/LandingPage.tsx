    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-cyan-500/30 relative overflow-hidden">
      ...
      <nav className="border-b border-white/5 bg-slate-950/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
           <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">VisionGuard AI</span>
           </div>
           <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-400">
              <a href="#features" className="hover:text-white transition-colors">Our Tech</a>
              <a href="#privacy" className="hover:text-white transition-colors">Privacy</a>
              <a href="#use-cases" className="hover:text-white transition-colors">How it Works</a>
           </div>
           <button 
             onClick={onStart}
      ...
      <section className="relative pt-24 pb-32">
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
           <div className="inline-flex items-center space-x-2 bg-slate-900/80 border border-slate-700 rounded-full px-4 py-1.5 mb-8 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <span className="text-xs font-medium text-slate-300">Live AI Body Detection</span>
           </div>
           ...
           <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-1000">
             ...
             <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600">Knows What It Sees.</span>
           </h1>
           ...
           <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
             VisionGuard AI uses smart technology to <span className="text-slate-200 font-semibold">recognize people</span> and understand their actions—like crawling or climbing.
           </p>
      ...
      <section id="features" className="py-24 bg-slate-900/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400">Advanced AI security working right in your web browser.</p>
          </div>
            ...
            {MOCK_FEATURES.map((feature, idx) => (
              <div key={idx} className="bg-slate-950 p-8 rounded-2xl border border-white/5 hover:border-cyan-500/30 transition-all duration-300 group hover:-translate-y-1">
                <div className="w-14 h-14 bg-slate-900 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-cyan-500/10 transition-colors shadow-inner">
                  {feature.icon === 'fingerprint' && <Scan className="w-7 h-7 text-cyan-400" />}
      ...
      <section id="use-cases" className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
           <div>
             <h2 className="text-3xl font-bold mb-8">Professional Security</h2>
             <div className="space-y-8">
                <div className="flex items-start space-x-5">
                   ...
                   <div>
                     <h3 className="font-bold text-lg text-slate-200">Works on Mobile</h3>
                     <p className="text-slate-400 mt-1 leading-relaxed">View your security feed on any phone or tablet, anywhere you are.</p>
                   </div>
                </div>
                <div className="flex items-start space-x-5">
                   ...
                   <div>
                     ...
                     <p className="text-slate-400 mt-1 leading-relaxed">Video stays on your device. We only look at body shapes, never record your face.</p>
                   </div>
                </div>
                <div className="flex items-start space-x-5">
                   ...
                   <div>
                     <h3 className="font-bold text-lg text-slate-200">Smart Activity Logs</h3>
                     <p className="text-slate-400 mt-1 leading-relaxed">Get simple text logs of all important events, easy to read and download.</p>
                   </div>
                </div>
             </div>
           </div>
                    ...
                    <div className="flex-1 p-4 bg-slate-950 relative overflow-hidden flex flex-col">
                       <div className="flex-1 bg-slate-900 rounded-lg border border-slate-800 relative flex items-center justify-center overflow-hidden">
                           <div className="absolute inset-0 bg-slate-900">
                              <div className="absolute inset-0 w-40 h-56 transform translate-y-4 left-1/2 -translate-x-1/2">
                                  <div className="absolute -inset-2 border border-red-500/50 rounded bg-red-500/5">
                                      <div className="absolute -top-3 left-0 bg-red-500 text-white text-[8px] font-bold px-1.5 py-0.5 rounded shadow-lg">INTRUDER 98%</div>
                                  </div>
                              </div>
                           </div>
                       </div>
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-12">
        <div className="max-w-7xl mx-auto px-6 text-center text-slate-500">
          <p className="mb-4 text-sm font-medium">VisionGuard AI • Modern AI Security</p>
        </div>
      </footer>
    </div>
  );
